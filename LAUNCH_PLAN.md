...
**44 lessons, ~161,000 characters of English body text, ~171 minutes of reading end to end**.
That is roughly **28,000 words** — a short book, not the long magazine article this line described
...
Phase 0 is where the app is now, and its first gate is **met** (44 lessons / 171 min) — the ≥40
