...
**44 lessons, ~157,000 characters of English body text, ~166 minutes of reading end to end**.
That is roughly **27,400 words** — a short book, not the long magazine article this line described
...
Phase 0 is where the app is now, and its first gate is **met** (44 lessons / 166 min) — the ≥40
