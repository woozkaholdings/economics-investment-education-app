...
**44 lessons, ~155,000 characters of English body text, ~165 minutes of reading end to end**.
That is roughly **26,900 words** — a short book, not the long magazine article this line described
...
Phase 0 is where the app is now, and its first gate is **met** (44 lessons / 165 min) — the ≥40
