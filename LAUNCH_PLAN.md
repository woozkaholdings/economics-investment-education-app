...
**40 sequenced lessons, 42 quiz questions with explanations, 29 glossary terms**, age-banded kids
...
**40 lessons, ~136,000 characters of English body text, ~120 minutes of reading end to end**.
...
|---|---|---|
| 40 lessons + quiz + glossary | **No** — finite; a few sittings to finish, then it is done | A one-time purchase |
...
Phase 0 is where the app is now, and its first gate is **met** (40 lessons / 120 min) — the ≥40
