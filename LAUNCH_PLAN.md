...
**44 lessons, ~164,000 characters of English body text, ~174 minutes of reading end to end**.
That is roughly **28,700 words** — a short book, not the long magazine article this line described
...
Phase 0 is where the app is now, and its first gate is **met** (44 lessons / 174 min) — the ≥40
