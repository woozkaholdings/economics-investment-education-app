...
**44 lessons, ~153,000 characters of English body text, ~162 minutes of reading end to end**.
That is roughly **26,600 words** — a short book, not the long magazine article this line described
...
Phase 0 is where the app is now, and its first gate is **met** (44 lessons / 162 min) — the ≥40
