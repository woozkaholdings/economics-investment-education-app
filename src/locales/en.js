export default {
    ...
    howReviewStep1: "Answer a lesson's check",
    howReviewStep1Body: "Answering the check question at the end of a lesson puts it in your queue. Questions you have never seen stay out of review.",
    ...
    reviewBoxesUnit: "questions",
    reviewBoxDayTemplate: "{n}d",
    reviewBoxesDescription: "Questions in review: {n}, grouped by how long until each one comes back. ",
    reviewBoxAriaTemplate: "The {days}-day box: {n}. ",
    ...
    priceSourceTemplate: "Sector and index prices from {source}.",
    economicsSourceCredit: "Economic readings from the Federal Reserve Bank of St. Louis (FRED®).",
};
