export default {
    ...
    pathDoneEyebrow: "路径已完成",
    pathDoneTitle: "你已学完全部课程",
    pathDoneSub: "没有待解锁的内容了 — 接下来就是复习",
    pathDoneBody: "重新拿出来看过的内容才会留下。你答过的每道检查题都在复习里，并会以越来越长的间隔再次出现。",
    pathDoneAction: "前往复习",
    trackMoney: "关于金钱的思考",
    ...
    qtNarrative: "美联储让债券到期 → 资金流出 → 收益率↑ → 股票↓ → 美元↑",
    aboutTabLabel: "关于",
    fontSizeLabel: "字体大小",
    ...
    howReviewStep1: "先答一道检测题",
    howReviewStep1Body: "答完课程末尾的检测题，该题就会进入你的队列。从未见过的题目不会出现在复习中。",
    ...
    linkMissLabel: "这节课还没有解锁",
    linkMissLockedTemplate: "你的链接指向“{title}”。完成这条路径上它前面的一节课，它就会打开。",
    linkMissUnknown: "你的链接指向的课程不在本应用中，可能来自旧版本。",
    linkMissDismiss: "关闭",
    ...
    reviewBoxesUnit: "题",
    reviewBoxDayTemplate: "{n} 天",
    reviewBoxesDescription: "复习中的题目：{n} 道，按距离下次复习的间隔分组。 ",
    reviewBoxAriaTemplate: "{days} 天组：{n} 题。 ",
    sectorsTitle: "板块表现",
    ...
    priceSourceTemplate: "板块与指数价格来自 {source}。",
    economicsSourceCredit: "经济数据来自圣路易斯联邦储备银行（FRED®）。",
};
