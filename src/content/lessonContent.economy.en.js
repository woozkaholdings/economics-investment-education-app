...
export const lessonContent = {
  ...
  "37": {
    ...
    "thinkAbout": "The Fed printed $1.75 trillion in QE1 starting in 2008 and unlimited in 2020. Who benefits most from QE? Those who own financial assets. Does this help explain growing wealth inequality?"
  },
  "38": {
    "sections": [
      {
    ...
    "sections": [
      {
        ...
        "body": "RULE 1: Don't let debt rise faster than income. Remember the family from “The Long-Term Debt Cycle” whose mortgage payment kept eating a bigger share of their paycheck? That's Rule 1 being broken in slow motion — eventually the debt burden crushes you, whether you're a household or a country.\n\nRULE 2: Don't let income rise faster than productivity. If a factory worker's wage keeps climbing but they're not producing any more per hour than before, the factory eventually can't compete with one elsewhere that pays less for the same output — jobs move, or prices rise until customers walk away.\n\nRULE 3: Do everything you can to raise your own productivity — learn a new skill, adopt a better tool or process, like the farmer's tractor from “Productivity Growth”. In the long run, this is what actually matters most, because it's the only one of the three that isn't just moving numbers around.\n\nThis is simple advice for you AND for policy makers alike. Most people — including most policy makers — don't pay nearly enough attention to it."
      },
      {
        "heading": "Putting It All Together",
        "body": "Now you have the whole template, built lesson by lesson: a slow, steady line of productivity growth (“Productivity Growth”) running underneath everything; a 75-100 year long-term debt cycle (“The Long-Term Debt Cycle”) rising and falling on top of that; and a faster 5-8 year short-term debt cycle (“The Short-Term Debt Cycle”) bouncing on top of both. Layer all three together, and you get a map for understanding where an economy has been, where it is now, and where it's probably headed.\n\nThe economy isn't random noise — it's a machine driven by transactions (“Transactions”), credit (“Credit”), and human nature repeating the same patterns generation after generation. Once you can see those patterns, whether you're an investor, a small business owner, or just someone trying to make sense of the news, you're equipped to make better decisions than someone reacting to headlines one at a time."
      }
    ],
