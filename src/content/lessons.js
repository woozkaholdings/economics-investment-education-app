...
export const lessons = [
  ...
  {
    id: 27, track: "money", icon: "📇", color: "#7c2d12",
    ...
    sections: [
      {
        heading: { en: "The Report Is the Record; the Score Is a Number Calculated From It", es: "El Informe Es el Registro; el Puntaje Es un Número Calculado a Partir de Él", ko: "보고서는 기록이고, 점수는 그것으로 계산된 숫자다", zh: "报告是记录，评分是由此计算出的数字", ja: "報告書は記録であり、スコアはそこから計算された数字である" },
        body: {
      ...
      {
        heading: { en: "Because a Report Is a Record, It Can Contain Errors — and Can Be Corrected", es: "Porque un Informe Es un Registro, Puede Contener Errores — y Puede Corregirse", ko: "보고서는 기록이기 때문에 오류가 있을 수 있고, 정정할 수도 있다", zh: "因为报告是一种记录，它可能包含错误——也可以被更正", ja: "報告書は記録であるため、誤りが含まれることがあり——訂正することもできる" },
        body: {
