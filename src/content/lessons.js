...
// bodies, takeaway, thinkAbout, and the end-of-lesson check's question,
// options and explanation — at 200 wpm, rounded. scripts/check-data.mjs §2
// recomputes it on every `npm test` and fails on drift, so a run that edits a
// lesson cannot leave a stale estimate on the Learn list. Do not hand-tune a
// value to look shorter: the number is a promise (§3.0.5) and it is summed
// into §4.3's Phase-0 content gate. Recalibrated 2026-08-17 (backlog item 56)
// when the old count was found to omit the check and the headings — ~20% of
// the words a learner reads. See DECISIONS.md for the model and the rate.
// ═══════════════════════════════════════════════════════════════════════════
export const lessons = [
  ...
  {
    id: 32, track: "economy", icon: "🔁", color: "#d97706", minutes: 4,
  ...
  {
    id: 33, track: "economy", icon: "🌊", color: "#dc2626", minutes: 4,
  ...
  {
    id: 34, track: "economy", icon: "🏗️", color: "#4f46e5", minutes: 6,
  ...
  {
    id: 35, track: "economy", icon: "💹", color: "#1e40af", minutes: 6,
  ...
  {
    id: 37, track: "economy", icon: "🏦", color: "#be185d", minutes: 4,
  ...
  {
    id: 38, track: "economy", icon: "🔄", color: "#059669", minutes: 6,
  ...
  {
    id: 39, track: "economy", icon: "📊", color: "#b45309", minutes: 4,
  ...
  {
    id: 5, track: "essentials", icon: "🧺", color: "#6d28d9", minutes: 4,
  ...
  {
    id: 17, track: "money", icon: "📈", color: "#b45309", minutes: 5,
  ...
  {
    id: 18, track: "money", icon: "⚖️", color: "#0f766e", minutes: 5,
  ...
  {
    id: 22, track: "money", icon: "🔍", color: "#0c4a6e", minutes: 4,
  ...
  {
    id: 23, track: "money", icon: "⏳", color: "#4338ca", minutes: 4,
  ...
  {
    id: 24, track: "money", icon: "🛍️", color: "#a16207", minutes: 3,
  ...
  {
    id: 25, track: "money", icon: "🌉", color: "#065f46", minutes: 5,
  ...
  {
    id: 26, track: "money", icon: "🏷️", color: "#be185d", minutes: 4,
  ...
  {
    id: 28, track: "money", icon: "🎰", color: "#7e22ce", minutes: 5,
