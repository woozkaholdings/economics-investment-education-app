    ...
    "sections": [
      ...
      },
      {
        ...
        "body": {
          ...
          "ko": "이 패턴들은 무작위가 아니라 35강의 금리 전달 메커니즘에서 나옵니다. 확장기에는 저렴한 자금이 성장주를 더 밀어올립니다. 정점에서는 그 메커니즘이 반대로 작동해 가치주와 단기 채권이 더 잘 버팁니다. 수축기에는 자금이 국채와 금으로 몰립니다. 저점에서는 가격이 이미 너무 떨어져서 작은 개선만으로도 저렴해 보입니다.",
          "zh": "这些模式并非随意——都源自第35课的利率传导机制。扩张期，廉价资金更能推动成长股。顶峰期，机制反转，价值股和短期债券更抗跌。收缩期，资金流向美国国债和黄金避险。低谷期，价格已跌至谷底，哪怕一点好转也显得便宜。",
          "ja": "これらのパターンは無作為ではなく、第35課の金利伝達メカニズムから生じる。拡大期は安いお金がグロース株を押し上げる。ピークではそのメカニズムが逆転し、バリュー株と短期債が持ちこたえやすい。収縮期は資金が米国債と金に向かう。底では価格が下がり切り、小さな改善でも割安に見える。"
        }
      }
    ],
    "takeaway": {
