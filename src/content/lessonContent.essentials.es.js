...
export const lessonContent = {
  ...
  "5": {
    ...
    "thinkAbout": "Piensa en las cuatro fases del ciclo de la lección 38. ¿Por qué tener acciones y bonos juntos podría suavizar el camino comparado con tener solo uno?"
  },
  "6": {
    "sections": [
      {
    ...
    "thinkAbout": "La lección 3 mostró que empezar temprano importa más que empezar en grande, porque la capitalización necesita tiempo sobre todo. ¿Por qué importaría más cuanto antes empieza alguien?"
  },
  "7": {
    "sections": [
      {
    ...
    "thinkAbout": "Ahora que entiendes los tramos marginales, piensa en la pregunta Traditional vs Roth de la Lección 6. Una aportación Traditional reduce el ingreso gravable a la tasa marginal de hoy. ¿Cambia eso tu forma de pensar la comparación?"
  },
  "8": {
    "sections": [
      {
  ...
  "10": {
    ...
    "thinkAbout": "La Lección 7 mostró que un aumento nunca reduce tu sueldo neto, porque la retención automática solo toma una porción algo mayor. Ahora imagina ese mismo aumento llegando como ingreso 1099 — sin nada retenido. ¿Cambia eso cómo evaluarías una oportunidad freelance frente a un salario con el mismo número nominal?"
  },
  "11": {
    "sections": [
      {
  ...
  "14": {
    ...
    "thinkAbout": "Alguien se divorcia, reescribe su testamento para dejarle todo a su nuevo cónyuge, pero nunca actualiza la designación de beneficiario del 401(k) que abrió años antes (Lección 6) — todavía figura su ex-cónyuge. Según esta lección, ¿quién recibe realmente ese 401(k) cuando esa persona muere?"
  },
  "15": {
    "sections": [
      {
