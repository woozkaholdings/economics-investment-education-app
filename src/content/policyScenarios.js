    ...
    options: [
      {
        ...
        outcome: {
          en: "Borrowing gets more expensive across the board — mortgages, car loans, business credit — so households buy less and firms build less, and the pressure pushing prices up eases. The cost lands on the other half of the mandate: pricier loans also mean less hiring, so unemployment usually drifts up. And none of it arrives at once, or at the same speed. Market rates move within weeks; spending, hiring and inflation take longer, and how much longer varies — a year or two is the usual rule of thumb, and the 2022–23 tightening beat it. That is why a committee can look like it is sitting still while an earlier move is still traveling through the economy.",
          es: "El crédito se encarece en todas partes — hipotecas, préstamos de auto, crédito empresarial —, así que los hogares compran menos y las empresas construyen menos, y cede la presión que empuja los precios hacia arriba. El costo cae sobre la otra mitad del mandato: préstamos más caros también significan menos contrataciones, así que el desempleo suele subir. Y nada de esto llega de golpe, ni a la misma velocidad. Las tasas de mercado se mueven en semanas; el gasto, la contratación y la inflación tardan más, y cuánto más varía: uno o dos años es la regla general, y el ajuste de 2022–23 la superó. Por eso un comité puede parecer quieto mientras una decisión anterior sigue abriéndose paso por la economía.",
          ko: "주택담보대출, 자동차 할부, 기업 대출까지 전반적으로 돈을 빌리는 비용이 올라갑니다. 가계는 덜 사고 기업은 덜 짓게 되어 물가를 밀어올리던 압력이 누그러집니다. 대가는 이중책무의 다른 한쪽에서 나옵니다. 대출이 비싸지면 채용도 줄어들기 때문에 실업률은 대개 올라갑니다. 게다가 이 모든 일은 한꺼번에, 같은 속도로 오지 않습니다. 시장 금리는 몇 주 안에 움직이고, 소비와 채용과 물가는 더 오래 걸리며 그 편차도 큽니다. 보통 1~2년을 경험칙으로 삼지만 2022~23년 긴축은 그보다 빨랐습니다. 그래서 위원회가 아무것도 하지 않는 것처럼 보이는 동안에도 이전 결정이 여전히 경제를 통과하고 있는 것입니다.",
          zh: "借钱的成本全面上升——房贷、车贷、企业信贷都变贵，于是家庭少买、企业少建，推高物价的压力随之缓解。代价落在双重使命的另一半上：贷款变贵也意味着招聘减少，失业率通常会往上走。而且这一切不会立刻到来，也不会以同样的速度到来。市场利率几周内就动；消费、招聘和通胀要慢得多，慢多少也差别很大——一到两年是通常的经验法则，而2022–23年的紧缩比它更快。所以委员会看起来按兵不动时，之前那次决定可能仍在经济中传导。",
          ja: "住宅ローン、自動車ローン、企業向け融資まで、借りるコストが一斉に上がります。家計は買い控え、企業は投資を抑えるため、物価を押し上げていた圧力はやわらぎます。代償はデュアルマンデートのもう一方に出ます。融資が高くつけば採用も減るので、失業率はたいてい上がります。しかもこれは一度に、同じ速さで訪れるわけでもありません。市場金利は数週間で動き、消費や採用、インフレはもっと時間がかかり、そのばらつきも大きいものです。1〜2年というのが通常の目安ですが、2022〜23年の引き締めはそれより速く効きました。だからこそ、委員会が動いていないように見える間も、以前の決定がまだ経済の中を進んでいるのです。",
        },
      },
      {
        id: "cut",
      ...
      },
      {
        ...
        outcome: {
          en: "Holding is a decision, not the absence of one. It leaves policy where it is and buys time to see how much of the last change has actually reached the economy — a real argument when the lag runs to a year or more and the previous move was recent. The risk sits on the other side: if high inflation keeps going, people start planning around it. Wages get negotiated and prices get set on the assumption it continues, and an expectation like that is harder to unwind than the original price increase was.",
          es: "Mantener es una decisión, no la ausencia de una. Deja la política donde está y da tiempo para ver cuánto del último cambio ha llegado de verdad a la economía: un argumento real cuando el rezago llega a un año o más y el movimiento anterior fue reciente. El riesgo está del otro lado: si la inflación alta se sostiene, la gente empieza a planificar contando con ella. Los salarios se negocian y los precios se fijan dando por hecho que sigue, y una expectativa así cuesta más de desarmar que la subida de precios original.",
          ko: "동결도 결정이지, 결정을 하지 않는 것이 아닙니다. 정책을 지금 자리에 두고, 지난번 변경이 실제로 경제에 얼마나 도달했는지 확인할 시간을 법니다. 시차가 1년 이상에 이르고 직전 조치가 최근이었다면 이는 진지한 논거입니다. 위험은 반대편에 있습니다. 높은 물가가 계속되면 사람들이 그것을 전제로 계획을 세우기 시작합니다. 임금 협상과 가격 책정이 “계속 오를 것”이라는 가정 위에서 이뤄지고, 그렇게 자리 잡은 기대는 처음의 물가 상승보다 되돌리기가 더 어렵습니다.",
          zh: "按兵不动同样是一个决定，而不是没有决定。它把政策留在原处，换来时间去看上一次调整究竟有多少真正传导到了经济里——当时滞长达一年以上、上一步又刚落下时，这是个实在的理由。风险在另一边：如果高通胀持续下去，人们会开始照着它做打算。工资谈判和定价都以“还会继续涨”为前提，而这样形成的预期，比最初那轮涨价更难扭转。",
          ja: "据え置きもまた決定であり、決定しないことではありません。政策を今の位置に置いたまま、前回の変更がどれだけ実際に経済へ届いたかを見る時間を稼ぎます。時差が一年以上に及び直前の一手が最近なら、これは本物の論拠です。リスクは反対側にあります。高いインフレが続けば、人々はそれを前提に計画を立て始めます。賃金交渉も値付けも「この先も続く」という想定の上で行われ、そうして根づいた予想は、最初の物価上昇よりも巻き戻すのが難しくなります。",
        },
      },
    ],
  },
    ...
    options: [
      {
        ...
        outcome: {
          en: "This is the conventional response, and it works the way the lesson describes: cheaper financing for a house, a car or a payroll supports hiring and investment — on the same lag, so it will not stop this quarter's job losses. Two limits are worth carrying forward. The dial stops at roughly zero, so a deep enough downturn exhausts it entirely, and that is exactly where the balance-sheet tools in the QE and QT lesson begin. And credit left cheap for long enough feeds the next expansion's inflation — the same tension, one turn of the cycle later.",
          es: "Es la respuesta convencional y funciona como describe la lección: financiar una casa, un auto o una nómina resulta más barato, lo que sostiene la contratación y la inversión, con el mismo rezago, así que no detendrá los despidos de este trimestre. Vale la pena llevarse dos límites. El dial se detiene cerca de cero, así que una recesión suficientemente profunda lo agota por completo, y justo ahí empiezan las herramientas de balance de la lección sobre QE y QT. Y el crédito barato mantenido el tiempo suficiente alimenta la inflación de la siguiente expansión: la misma tensión, una vuelta más del ciclo.",
          ko: "가장 일반적인 대응이며, 레슨이 설명한 그대로 작동합니다. 집, 자동차, 급여를 융통하는 비용이 싸지면서 채용과 투자를 떠받칩니다. 시차는 똑같이 존재하므로 이번 분기의 실직을 막아주지는 못합니다. 기억해둘 한계가 둘 있습니다. 다이얼은 대략 0에서 멈추기 때문에 충분히 깊은 침체는 이 수단을 완전히 소진시키며, 바로 거기서 QE와 QT 레슨의 대차대조표 수단이 시작됩니다. 그리고 값싼 신용을 오래 두면 다음 확장기의 물가 상승을 키웁니다. 같은 긴장이 사이클 한 바퀴 뒤에 다시 나타나는 것입니다.",
          zh: "这是常规做法，运作方式和课文说的一样：买房、买车、发工资的融资成本下降，支撑招聘和投资——时滞同样存在，所以它挡不住这个季度的裁员。有两个限制值得记住。旋钮大致到零就停了，足够深的衰退会把它彻底用尽，而那正是 QE 与 QT 那一课里资产负债表工具登场的地方。另外，信贷便宜得太久，会为下一轮扩张的通胀埋下伏笔——同一种张力，只是晚了一个周期。",
          ja: "これが標準的な対応で、レッスンの説明どおりに働きます。住宅、自動車、給与の資金繰りが安くなり、採用と投資を支えます。同じように時差があるので、今四半期の雇用喪失は止められません。持ち帰るべき限界が二つあります。ダイヤルはおよそゼロで止まるため、十分に深い不況はこの手段を使い切ってしまい、まさにそこからQEとQTのレッスンで扱うバランスシート手段が始まります。そして安い信用を長く置きすぎると、次の拡大局面のインフレを育てます。同じ緊張が、サイクルを一周して戻ってくるのです。",
        },
      },
      {
        id: "hike",
