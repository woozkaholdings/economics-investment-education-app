    ...
    options: [
      {
        ...
        outcome: {
          en: "Borrowing gets more expensive across the board — mortgages, car loans, business credit — so households buy less and firms build less, and the pressure pushing prices up eases. The cost lands on the other half of the mandate: pricier loans also mean less hiring, so unemployment usually drifts up. And none of it arrives at once. Most of the effect shows up 12–24 months later, which is why a committee can look like it is sitting still while an earlier move is still travelling through the economy.",
