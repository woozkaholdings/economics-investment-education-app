...
export const lessonContent = {
    ...
    "sections": [
      {
        ...
        "body": "Imagina un barrio donde los precios de las viviendas han subido todos los años durante una década. Una familia compra una casa no solo para vivir en ella, sino porque confía en que valdrá más el año que viene; así que estira su presupuesto y pide la hipoteca más grande que un banco le apruebe. A lo largo de muchos ciclos cortos como el de “El Ciclo de Deuda a Corto Plazo”, esto ocurre una y otra vez: las deudas crecen más rápido que los ingresos, porque la naturaleza humana prefiere pedir prestado y gastar más hoy antes que pagar la deuda.\n\nLos prestamistas siguen prestando con soltura durante todo este proceso, porque cualquiera puede ver la evidencia con sus propios ojos: los ingresos suben, las viviendas valen más, la bolsa está disparada. La confianza se alimenta a sí misma.\n\nCuando suficientes personas piden mucho prestado para comprar un activo —casas, acciones, lo que sea— solo porque esperan que el precio siga subiendo, eso empuja los precios todavía más arriba. Eso es una burbuja.\n\nMientras los ingresos también sigan subiendo, la carga de la deuda (la proporción entre lo que se debe y lo que se gana) parece manejable. Pero nada sube para siempre, y ese es justamente el problema."
      },
      {
        "heading": "El Pico y Desapalancamiento",
        "body": "Con el tiempo, la familia de nuestro ejemplo descubre que el pago de la hipoteca se come cada año una parte mayor de su sueldo, mientras el valor de su casa deja de subir. Recortan otros gastos para poder seguir pagando. Multiplica esa familia por millones y los ingresos de toda la economía caen, la gente parece menos solvente a ojos de los prestamistas, el crédito se seca y el ciclo entero se da vuelta. Este es el pico de deuda a largo plazo.\n\nEste es el patrón detrás de algunas de las caídas más dolorosas de la historia: EE.UU. en 2008, Japón en 1989 y EE.UU. en 1929.\n\nEn un desapalancamiento, el gasto cae, el crédito desaparece, los precios de los activos —incluida la casa de esa familia— bajan, los bancos quedan presionados porque los deudores no pueden pagar, la bolsa se desploma y las tensiones sociales aumentan.\n\nLa diferencia clave con una recesión corriente: las tasas de interés no pueden acudir al rescate, porque a estas alturas suelen estar ya cerca del 0%."
      },
      {
        "heading": "Por Qué Es Difícil Verlo Desde Dentro",
        "body": "Hay una razón por la que las caídas cortas resultan familiares y las largas toman a la gente por sorpresa: casi todos los adultos de hoy han vivido varios ciclos cortos de deuda —llega uno cada 5 a 8 años, así que al llegar a la edad adulta la mayoría recuerda directamente al menos dos o tres—. El ciclo largo abarca de 75 a 100 años, más o menos lo que dura una vida humana. Eso significa que casi nadie vivo recuerda en persona la última vez que alcanzó su pico.\n\nLa generación que vivió el desplome de 1929 y la Depresión que vino después arrastró durante el resto de su vida una cautela duradera frente a la deuda y el apalancamiento. Pero esa generación ya no está, y lo que aprendió en carne propia nunca se pudo transmitir del todo a quienes solo lo leyeron en un libro de texto. Cada generación nueva tiende a reaprender el patrón viviéndolo, no recordándolo; en parte por eso 'esta vez es diferente' se sigue diciendo justo antes de cada pico, no porque la gente sea tonta, sino porque ya no queda memoria viva contra la cual contrastar la afirmación.\n\nEsto no es razón para esperar una repetición en ninguna fecha concreta —nadie puede anticipar el momento—, pero sí explica por qué el ciclo largo es fácil de pasar por alto incluso mientras las mismas señales de alerta (deuda que crece respecto al ingreso, endeudarse para comprar activos solo porque los precios suben) están todo el tiempo en los datos."
      }
    ],
    ...
    "sections": [
      {
        ...
        "body": "Cuando un hogar —o un país entero— ha asumido demasiada deuda, en realidad solo hay cuatro palancas que alguien pueda accionar:\n\n1. RECORTAR GASTO (Austeridad). Piensa en el gobierno de una ciudad que, ante un agujero presupuestario, despide trabajadores y cancela contratos para ahorrar. Es doloroso y puede salir por la culata: cuando la ciudad deja de pagar a esos trabajadores, ellos gastan menos en los negocios locales, los ingresos caen en toda la ciudad y la carga de la deuda respecto al ingreso puede acabar PEOR, no mejor.\n\n2. REDUCIR DEUDAS (Impagos y Reestructuración). Imagina un banco que exige el pago de préstamos que sabe que no se van a devolver y termina dando algunos por perdidos. Los deudores no pueden pagar, los bancos quedan presionados y la gente corre a retirar sus ahorros antes de que quiebren más bancos. Así se ve una depresión.\n\n3. REDISTRIBUIR RIQUEZA. Un gobierno sube los impuestos a quienes más ganan para financiar ayudas al resto. Puede aliviar la carga, pero también suele elevar la tensión social entre quienes pagan más y quienes reciben más.\n\n4. IMPRIMIR DINERO. Cuando las tasas ya están cerca del 0%, el banco central crea dinero nuevo para comprar bonos del gobierno y otros activos financieros, lo que en la práctica vuelve a llenar el pozo que la austeridad y los impagos acaban de vaciar. Esto es inflacionario y estimulante, lo contrario de las tres primeras herramientas."
      },
      {
        "heading": "Desapalancamiento Hermoso vs Feo",
        "body": "La clave es el EQUILIBRIO, como un cocinero ajustando la sazón: demasiado de las herramientas deflacionarias (recortar, impagar, gravar) sin suficiente de la inflacionaria (imprimir dinero), y el resultado sale amargo y depresivo. Demasiado de la herramienta inflacionaria por sí sola, y se convierte en cambio en un desastre inflado.\n\nSi aciertas con la mezcla, obtienes un 'desapalancamiento hermoso': las deudas bajan respecto al ingreso, el crecimiento se mantiene positivo y la inflación sigue siendo manejable. Muchos economistas señalan la recuperación de EE.UU. desde 2008 hasta aproximadamente 2015 como un ejemplo de ese equilibrio funcionando razonablemente bien.\n\nSi te equivocas con la mezcla, obtienes un 'desapalancamiento feo'. Alemania en los años veinte se apoyó casi por completo en imprimir dinero, y el resultado fue una hiperinflación tan severa que la gente llegó a llevar carretillas de billetes solo para comprar pan. EE.UU. en los años treinta se apoyó casi por completo en la austeridad, y el resultado fue la Gran Depresión.\n\nEn cualquiera de los dos casos, recuperarse de un pico de deuda a largo plazo suele llevar cerca de una década, lo que a menudo se llama la 'década perdida'."
      },
      {
        "heading": "Por Qué la Herramienta #4 No Está Disponible para Todos",
        "body": "Las cuatro herramientas dan por supuesto algo que no es cierto en todas partes: que la deuda está denominada en una moneda que el propio banco central del deudor puede crear.\n\nCuando la deuda de un país está denominada en su propia moneda, imprimir dinero es una opción real: dolorosa e inflacionaria, pero convierte una deuda impagable en una pagable, porque el banco central puede literalmente crear las unidades necesarias para pagarla. Un país cuya deuda está denominada en una moneda extranjera que no puede imprimir no tiene esa cuarta palanca en absoluto. Si el dinero se acaba, no hay imprenta que echar a andar: solo la herramienta 1 (austeridad) y la herramienta 2 (impago) están realmente sobre la mesa, por dolorosas que sean.\n\nEste solo hecho —en la moneda de quién está la deuda— explica en buena parte por qué las crisis de deuda golpean de forma muy distinta según dónde ocurran. Los países que se endeudaron fuertemente en moneda extranjera durante la crisis de deuda latinoamericana de los años ochenta no tuvieron la opción de imprimir cuando los prestamistas extranjeros se retiraron, y en su mayoría pasaron por el impago y la reestructuración. Japón, en cambio, carga con una de las ratios de deuda pública sobre PIB más altas del mundo; pero como esa deuda está denominada casi por completo en yenes y se debe en gran medida a sus propios ciudadanos e instituciones, su banco central ha podido apoyarse en la herramienta 4 durante décadas sin un impago.\n\nAsí que antes de preguntar si el desapalancamiento de un país será 'hermoso' o 'feo', la pregunta más básica es si la herramienta 4 está siquiera en el menú."
      }
    ],
    "takeaway": "Los ingresos deben crecer más rápido que la deuda. Imprimir dinero suficiente para compensar la deflación, pero no tanto como para provocar hiperinflación. El equilibrio lo es todo.",
    "thinkAbout": "Si imprimir dinero compensa la caída del crédito, el gasto total se mantiene igual. Así que imprimir dinero no provoca inflación SI el crédito está desapareciendo al mismo ritmo. ¿Cambia eso tu forma de pensar sobre la impresión de dinero?"
  },
  "35": {
    "sections": [
      {
      ...
      },
      {
        ...
        "body": "Esta es la razón por la que ese único dial llega tan lejos. Supongamos que el Fed sube las tasas. Una empresa tecnológica joven que se financiaba barato para costear años de crecimiento enfrenta ahora un costo de capital mucho más alto, y su acción —valorada según años de ganancias futuras— tiende a caer con más fuerza que la de una empresa de servicios públicos estable. Los bonos ya existentes, que pagan una tasa fija más baja, se vuelven menos atractivos frente a los bonos nuevos que pagan la tasa más alta de hoy, así que los precios de los bonos también caen. Una familia que busca casa descubre que el pago de la hipoteca por esa misma vivienda es de golpe varios cientos de dólares más al mes, y las ventas de viviendas se enfrían durante los 6 a 12 meses siguientes. Mientras tanto, una simple cuenta de ahorros o un fondo del mercado monetario vuelve a pagar un rendimiento realmente competitivo, y el dólar estadounidense tiende a fortalecerse a medida que ahorradores de todo el mundo persiguen ese rendimiento.\n\nBaja las tasas y la secuencia tiende a correr al revés: las acciones suben, los precios de los bonos suben, los inmuebles se recuperan, el oro suele subir y el dólar tiende a debilitarse.\n\nLa regla informal que los inversionistas citan para todo esto: \"No luches contra el Fed.\" Históricamente, la relajación del Fed (los recortes de tasas) ha coincidido con precios de activos al alza, mientras que el endurecimiento (las subidas de tasas) ha coincidido con condiciones de mercado más cautelosas."
      },
      {
        "heading": "El Doble Mandato del Fed: Dos Objetivos Que Pueden Chocar",
        "body": "Girar el dial no es una decisión libre tomada en el vacío: el Congreso le dio al Fed dos objetivos legalmente obligatorios a la vez, conocidos como su doble mandato: precios estables (en la práctica, alrededor del 2% de inflación al año, el mismo objetivo del tablero de indicadores de “Leyendo Indicadores Económicos”) y máximo empleo (tanta gente trabajando como la economía pueda sostener sin recalentarse).\n\nLa mayor parte del tiempo los dos objetivos apuntan en la misma dirección: una economía sana y en crecimiento tiende a mantener juntos los precios estables y el desempleo bajo. Lo difícil es cuando se separan. Subir las tasas para enfriar la inflación enfría también la contratación: las empresas que enfrentan préstamos más caros se expanden menos y contratan menos. Bajar las tasas para proteger el empleo puede dejar que la inflación corra más caliente, porque el crédito más barato alimenta más gasto del que la economía puede abastecer sin que suban los precios.\n\nEsta tensión es justamente la razón por la que las decisiones del Fed se debaten tanto en lugar de seguir una fórmula fija: 2021-2023 se lee ampliamente como un caso en el que el Fed juzgó que la inflación se estaba recalentando y se inclinó con fuerza hacia la mitad del mandato dedicada a la estabilidad de precios, aceptando cierto riesgo para la mitad dedicada al empleo. Un Fed que leyera los datos de otra forma, o que enfrentara un momento económico distinto, podría inclinarse razonablemente hacia el otro lado. No hay ecuación que resuelva el dilema: es una decisión de juicio que el comité de política del Fed toma reunión a reunión, sopesando los mismos indicadores de “Leyendo Indicadores Económicos”."
      }
    ],
  ...
  "36": {
    "sections": [
      {
        "heading": "¿Qué es la Curva de Rendimiento?",
        "body": "Imagina que le prestas dinero a un amigo. Si te lo devuelve la semana que viene, quizá ni siquiera le cobres intereses. Si no te lo devuelve hasta dentro de 10 años, querrías bastante más a cambio: en un plazo más largo pueden salir mal más cosas. Esa es la lógica básica detrás de la curva de rendimiento: un gráfico de la tasa de interés que paga el gobierno por pedir dinero prestado a distintos plazos (2 años, 10 años, 30 años).\n\nNORMAL (pendiente ascendente) — Los préstamos a plazos más largos pagan tasas más altas que los cortos, exactamente como en el ejemplo del amigo. Esta es la forma sana y habitual.\n\nPLANA — Las tasas cortas y las largas convergen. Es la forma que tiene el mercado de bonos de encogerse de hombros: una advertencia de que puede venir una desaceleración.\n\nINVERTIDA (las tasas cortas por encima de las largas) — Esto es lo bastante extraño como para ser una señal de alarma real: significa que los prestamistas están dispuestos a aceptar MENOS por inmovilizar su dinero 10 años que por hacerlo 2, lo que suele indicar que esperan que la economía se debilite y que las tasas caigan sustancialmente en el intervalo. Históricamente es una de las señales de recesión más fiables, con un plazo de anticipación típico de 12 a 18 meses. Cada recesión de EE.UU. desde 1955 estuvo precedida por una inversión, aunque no toda inversión ha sido seguida de una recesión, así que es una señal fuerte, no una certeza.\n\nEMPINADA — La brecha vuelve a ensancharse, algo que suele verse después de que el Fed empieza a recortar las tasas de corto plazo. Es una forma que se asocia con frecuencia a la recuperación."
      },
      {
        "heading": "Por Qué Funciona la Señal — y Dónde Puede Engañar",
        "body": "El mecanismo detrás de la señal son las expectativas, no la magia. Un rendimiento a largo plazo es, a grandes rasgos, una apuesta del mercado sobre el promedio en el que quedarán las tasas de corto plazo a lo largo de todo ese período. Si el mercado espera que el banco central recorte las tasas con fuerza porque viene una desaceleración, esa expectativa tira hoy hacia abajo del rendimiento a 10 años, incluso mientras el rendimiento a 2 años todavía refleja la tasa corta más alta de hoy. Que esa brecha se vuelva negativa es el mercado poniéndole precio a una debilidad futura antes de que aparezca en los datos de empleo o de PIB.\n\nEl diferencial concreto que los economistas citan con más frecuencia es el '2s10s': el rendimiento del Tesoro a 2 años menos el de 10 años. Se invirtió a mediados de 2022 y siguió invertido cerca de dos años, el período más largo registrado, antes de volver a terreno positivo en 2024, mucho después del plazo de anticipación 'típico' de 12 a 18 meses.\n\nEsa distancia entre la señal y el resultado es el límite real que conviene tener presente: dice que una desaceleración es más probable, no cuándo llegará ni qué tan severa será. La inversión de 1966 precedió una fuerte desaceleración del crecimiento, pero ninguna recesión oficial. Leer bien la curva significa sopesarla junto con los datos de empleo, inflación y crédito: es un insumo, no un pronóstico por sí solo."
      },
      {
        "heading": "La Prima por Plazo: Por Qué los Rendimientos No Son Solo Expectativas de Tasas",
        "body": "La sección anterior describió el rendimiento a largo plazo como, a grandes rasgos, una apuesta sobre el promedio en el que quedarán las tasas de corto plazo. Eso es la mayor parte de la historia, pero no toda: los inversionistas también quieren una compensación adicional solo por inmovilizar su dinero durante más tiempo, al margen de dónde crean que acabarán las tasas. Esa compensación adicional se llama prima por plazo.\n\nEsta es la razón de que exista: inmovilizar dinero en un bono a 10 años conlleva riesgos que uno a 2 años no tiene —más años para que una inflación inesperada erosione el rendimiento, más años de vaivenes de precio si el inversionista necesita vender antes del vencimiento y menos certeza en general—. Los inversionistas exigen algo más de rendimiento para aceptar eso, por encima de las puras expectativas de tasas.\n\nAsí que un rendimiento a 10 años son en realidad dos cosas apiladas: la expectativa media de tasas del mercado, más la prima por plazo. El Banco de la Reserva Federal de Nueva York publica una estimación muy citada, pero la prima por plazo en sí no es directamente observable en los datos: hay que estimarla a partir de un modelo, y distintos modelos no coinciden entre sí.\n\nEsto importa para leer la curva: la prima por plazo ha ido a la baja desde los años ochenta y en ocasiones se ha vuelto negativa, lo que significa que los inversionistas estaban dispuestos a aceptar menos por un bono a 10 años de lo que sugerirían las puras expectativas de tasas, a menudo durante huidas hacia la seguridad. Una prima por plazo a la baja o negativa puede ayudar a empujar la curva hacia la inversión incluso sin que el mercado espere un gran ciclo de recortes, lo que es una razón más por la que la señal de la sección anterior no es infalible: una inversión puede reflejar un cambio en la prima por plazo en lugar de —o además de— un cambio real en las expectativas de tasas."
      }
    ],
