...
| Kids curriculum | Part of the product per §0 (kids→adults) | **21 blurbs** (7 per age band x 3 bands), parent-facing, up from 9 as of 2026-08-07 and 15 as of the first round of 2026-08-15 additions — see `LAUNCH_PLAN.md` §2.6 and backlog item 21 | ❌ Gap — still 3 fields/band (`lessons`/`activity`/`parentTip`), not lesson-shaped; child-facing UI is an owner/COPPA decision (§10.3), unchanged. **2026-08-16:** growing the blurb count further is no longer the default next step for this row — see `DECISIONS.md` ("Kids financial-literacy content...") |
