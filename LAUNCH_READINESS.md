...
- Lesson catalogue size and translation volume ratio (10.4) — **you do not refresh these by hand, and
  ...
  fails and names the replacement string. **As of 2026-08-17 the same command also owns eight figures
  in `LAUNCH_PLAN.md`** (§1's asset sentence, §2.5's two track-id ranges, §3.2's progress figure,
  §4.0's volume/word-count/asset-table figures, and §4.3's Phase-0 gate verdict — backlog item 55), so
