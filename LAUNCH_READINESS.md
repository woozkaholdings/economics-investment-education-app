...
**Since 2026-08-17 the same generator also owns `LAUNCH_PLAN.md`'s catalogue figures** (backlog item
...
- Lesson catalogue size and translation volume ratio (10.4) — **you do not refresh these by hand, and
  as of 2026-08-17 (backlog item 47) you cannot let them go stale.** Both figures are generated by
  `scripts/refresh-readiness.mjs`, which `npm test` runs in `--check` mode: if the §4.3 catalogue row
