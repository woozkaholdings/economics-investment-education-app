...
**Last refreshed: 2026-08-06 (lesson 26 added, item 17).**
...
against the app's own per-lesson `estimateMinutes` (summed): 55 min — the two methods still drift apart
by about the same margin as at 25 lessons (60 vs. 55), consistent with the drift noted since this
