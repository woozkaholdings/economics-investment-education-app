...
|---|---|---|---|
| Lesson catalogue size | ≥40 lessons / ~2 hours | **40 lessons / 122,042 English chars / 108 min** — split across **money (28)** + **economy (12)** tracks, see `LAUNCH_PLAN.md` §2.5 | 🟡 Lesson-count clause **met** (40/40) since lesson 40 (2026-08-09); char/time clause not met — 108/120 min, ~90% |
